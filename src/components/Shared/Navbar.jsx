...
function Navbar() {
  ...
  return (
    <div className='bg-[#FEFAE0] h-[80px] w-full fixed z-20'>
        ...
        <a href="https://www.linkedin.com/pulse/hospital-management-system-sai-krishna-kolliseti-6yd1f/?trackingId=tgqWlMXjRcKWSSoMwYeIzg%3D%3D" target="_blank" rel="noopener noreferrer">
